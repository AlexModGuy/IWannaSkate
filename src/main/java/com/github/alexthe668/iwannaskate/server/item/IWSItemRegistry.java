...
public class IWSItemRegistry {
    ...
    public static final RegistryObject<Item> SKATING_MANUAL = DEF_REG.register("skating_manual", () -> new SkatingManualItem(new Item.Properties().tab(IWSCreativeTab.INSTANCE).stacksTo(1)));
    ...
    public static final RegistryObject<Item> BEANIE = DEF_REG.register("beanie", () -> new DyeableHatItem(ArmorMaterials.LEATHER, "beanie", 0X818181, new Item.Properties().tab(IWSCreativeTab.INSTANCE)));
