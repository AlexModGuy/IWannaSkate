...
public class IWSItemRegistry {
    ...
    public static final RegistryObject<Item> SKATING_MANUAL = DEF_REG.register("skating_manual", () -> new SkatingManualItem(new Item.Properties().tab(IWSCreativeTab.INSTANCE)));
