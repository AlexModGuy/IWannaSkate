...
public class IWSEntityRegistry {
    ...
    public static final RegistryObject<EntityType<WanderingSkaterEntity>> WANDERING_SKATER = DEF_REG.register("wandering_skater", () -> (EntityType)EntityType.Builder.of(WanderingSkaterEntity::new, MobCategory.CREATURE).sized(0.8F, 1.9F).build("wandering_skater"));
